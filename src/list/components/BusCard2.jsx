...
const BusCard2 = ({ bus }) => {
  ...
  return (
    <div className=" w-[calc(50%-24px)] bg-white p-6 mb-6 rounded-xl shadow-lg border border-gray-100 transition duration-300 hover:shadow-xl">
      {/* Header: Operator, Type & Ratings */}
      <div className="flex justify-between items-start mb-4 pb-3 border-b border-gray-100 gap-4">
        <div>
          <h3 className="text-2xl font-bold text-gray-800">{busName}</h3>
          <p className="text-xl font-bold text-gray-800 mt-1">{operatorName}</p>
        </div>
      ...
      <p className="text-md text-gray-500 flex items-center mb-1">
      ...
      <div className="flex justify-between items-center text-center sm:text-left my-4">
        ...
        <div className="flex-1 flex flex-col items-center mx-4">
          <FaArrowRight className="text-3xl text-orange-500 my-1" />
        </div>
      ...
      {/* <div className="flex justify-between items-center pt-4 mt-4 border-t gap-4 border-gray-100">
        ...
        <button className="bg-orange-500 text-white font-bold px-4 py-3 rounded-lg shadow-md hover:bg-orange-600 transition duration-200 tracking-wider">
          View Seats
        </button>
      </div> */}
    </div>
